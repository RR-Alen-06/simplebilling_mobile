            ...
            child: billsAsync.when(
              data: (bills) {
                final filtered = bills.where((b) {
                  ...
                  final phoneMatch = (b.customerPhone ?? '').contains(_searchTerm);
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    const SyncStatusBadge(status: SyncStatus.synced, size: 16),
                                  ],
                                ),
                                Text(
                            ...
                            Row(
                              ...
                              children: [
                                OutlinedButton.icon(
                                  ...
                                  onPressed: () {
                                    if (settings != null) {
                                      ReceiptGenerator.printThermalReceipt(bill, settings);
                                    }
                                  },
                                ),
                                const SizedBox(width: 8),
                                ElevatedButton.icon(
                                  ...
                                  onPressed: () {
                                    if (settings != null) {
                                      ReceiptGenerator.printA4Invoice(bill, settings);
                                    }
                                  },
                                ),
                              ],
